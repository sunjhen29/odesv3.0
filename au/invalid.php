...
<div id="submenu">
	<ul>
		...
		<?php } ?>
		<li><a href="invalid.php" class="active" style="color: red;">Invalid</a></li>
		<li><a href="view.php">View</a></li>
	</ul>
	<h3><?php echo "(".$session->state.") ".$session->publication_name." ".$session->publication_date; ?></h3>
</div> <!-- end of submenu -->
<div id="content">
	<form name="nzproperty" id="nzproperty" method="post" action="process_invalid.php">
	<div id="address"> 
		<h3><span id="view_address"><?php echo $invalid['id'] ? 'Modify Invalid Record' : 'Add Invalid Record'; ?></span></h3>
			<fieldset>
				...
				<label class="proplabel">Street Name</label>
					<input class="medium" name="street_name" type="text" value="<?php echo htmlentities($invalid['Street_Name']); ?>" pattern="[aA-zZ0-9 ]{1,50}"/>
				...
				<label>Property State</label>
					<select name="property_state">
						<?php echo keypairs($state_lkp_au_inv,$invalid['Property_State'] ? $invalid['Property_State'] : $session->state,false,$session->state); ?>
					</select><br>
	...
	<div id="listingdetails">
		<fieldset>
			...
			<?php if(substr($session->batch_id,13,1) == 'S'){ ?>
			<input class="rightside" id="auction_time" name="auction_time" type="text" placeholder="HH:MM AM/PM" value="<?php echo htmlentities($invalid['Auction_Time']); ?>" pattern="^[0-1][0-9]:[0-5][0-9] [APap][mM]$"/>
	...
	<div id="attributes">	
		...
		<div class="property_attribute">
			<input name="bathrooms" class="small" type="text" value="<?php echo htmlentities($invalid['Bathrooms']); ?>" pattern="[0-9]{1}"/>
		...
		<div class="property_attribute tick">
		...
		<fieldset>
			<div class="agent">
				<table id="agenttable"> 
					...
					<tr>
						<td>Contact</td>
						<td><input name="contact" type="text" value="<?php echo htmlentities($invalid['Contact']); ?>" style="width: 550px;" pattern="[0-9, ]{1,100}"/></td>
					</tr>
				</table>
			</div>
		</fieldset>
