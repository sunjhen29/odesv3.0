<?php 
	...
	if ($_GET['id'] != 0){
		...
		$property_id = NewZealand::find_property($session->state,$session->publication_name,$_GET['unit_no'],$_GET['street_no'],$_GET['street_no_suffix'],$_GET['street_name'],$_GET['street_extension'],$_GET['street_direction'],$_GET['suburb'],$_GET['city'],$_GET['sale_rent'],$_GET['property_type']);
		$details = NewZealand::find_property_details($property_id['id']);
		$agents = Agent::find_by_record_id($property_id['id']);
	}
?>
	...
	<div id="additional">
		<fieldset>
			<div>
				...
				<input name="additional_property" style="width:400px" type="text" value="<?php echo htmlentities($details['Additional_Property']);?>"/>
			</div>
		</fieldset>
	</div>
	</div><!-- end of display -->
