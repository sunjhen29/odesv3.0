<?php 
	...
	$session->log_start();
	$details = NewZealand::find_next($session->batch_id,$session->state,$session->publication_name,$session->publication_date);
?>
...
<div id="content">
	...
	<div id="address"> 
		<span id="view_address"></span>
			<fieldset>
				<input name="id" class="small" type="hidden" value="<?php echo htmlentities($details['id']);?>" autofocus required/><br><br>
