<?php 
	...
	$session->log_start();
	$properties = NewZealand::view($session->batch_id,$session->state,$session->publication_name,$session->publication_date);
	$totalrecords = NewZealand::rowCount($session->batch_id,$session->state,$session->publication_name,$session->publication_date);
?>
	...
	<table id="view">
		...
		<tbody>
			...
			<tr>
				...
				<td><?php echo $property['unit_no'];if (!empty($property['unit_no'])){echo "/";} echo $property['street_no']." ".$property['street_name']." ".$property['street_extension']." ".$property['street_direction']." ".$property['suburb']." ".$property['city']; ?></td>
