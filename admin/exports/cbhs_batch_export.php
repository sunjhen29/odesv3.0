...
require_once("../../_includes/initialize.php");
	...
	$exportfilenames = Cbhs::group_by_batch($_GET['id']);
...
header('Expires: -1');
	...
	foreach($exportfilenames as $exportfilename) {
		$xmlDoc = new DOMDocument();
		$cbhs = Cbhs::find_by_exportfilename($exportfilename['exportfilename'],$_GET['id']);
		...
		foreach ($cbhs as $row) {
			...
			$filename = 'C:\\' . substr($row['exportfilename'], 0, -4) . ".xml";
		}
