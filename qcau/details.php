<?php 
	...
	$publication_lookup = Publication::publication_lookup_au('AU',$_GET['state']);
?>
...
<div id="content">
	...
	<div id="maindetails">
		...
		<label class="proplabel">State</label>
			<input class="small" type="text" name="state" value="<?php echo htmlentities($_GET['state']);?>" readonly /><br>	
		<label class="proplabel">Publication Name</label>
			<input type="text" name="publication_name" style="width: 525px;" value="<?php echo htmlentities($_GET['publication_name']);?>" readonly /><br>
		<label class="proplabel">Publication Date</label>
			<input id="publication_date" name="publication_date" type="text" value="<?php echo htmlentities($_GET['publication_date']);?>" pattern="^(((0[1-9]|[12]\d|3[01])/(0[13578]|1[02])/((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)/(0[13456789]|1[012])/((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])/02/((19|[2-9]\d)\d{2}))|(29/02/((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$" required readonly /><br>
		<label class="proplabel">Batch ID</label>
			<input name="batch_id" type="text" value="<?php echo htmlentities($_GET['batch_id']);?>" pattern="[a-zA-Z0-9]{3}[_][0-9]{8}[_][sS|Rr][_][0-9]{2}" required readonly /><br>
		</fieldset>
			...
			<div class="agent">
				<table id="agenttable"> 
					...
					<tr>
						...
						<td><input class="firstname" name="agent_firstname[]" type="text" value="<?php echo htmlentities($agent['Agent_Firstname']);?>" style="width: 130px;" pattern=".{2,}"></td>
