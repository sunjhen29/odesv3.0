	<div id="attributes">	
		...
		<div class="property_attribute">
			<input name="lockup_garages" class="small" type="text" value="<?php echo htmlentities($details['Lockup_Garages']);?>" pattern="[1-9]{1}"/>
		...
		<div class="property_attribute">
			<input name="lounge_rooms" class="small" type="text" value="<?php echo htmlentities($details['Lounge_Rooms']);?>" pattern="[1-9]{1,2}"/>
		...
		<div class="property_attribute">
			<input name="no_of_study" class="small" type="text" value="<?php echo htmlentities($details['No_Of_Study']);?>" pattern="[1-9]{1}"/>
		...
		<div class="property_attribute">
			<input name="toilets" class="small" type="text" value="<?php echo htmlentities($details['Toilets']);?>" pattern="[1-9]{1}"/>
			<label>Toilets</label>
		</div>
		<div class="property_attribute">
			<input name="ensuites" class="small" type="text" value="<?php echo htmlentities($details['Ensuites']);?>" pattern="[1-9]{1}"/>
			<label>Ensuites</label>
		</div>		
		<div class="property_attribute">
			<input name="lounge_dining" class="small" type="text" value="<?php echo htmlentities($details['Lounge_Dining']);?>" pattern="[1-9]{1}"/>
